...
-- add foreign key constraints to world database
-- CountryLanguage.CountryCode -> Country.Code
ALTER TABLE CountryLanguage
ADD CONSTRAINT fk_CountryLanguage_CountryCode 
FOREIGN KEY(CountryCode)
REFERENCES Country(Code);

-- City.CountryCode -> Country.Code
ALTER TABLE City
ADD CONSTRAINT fk_City_CountryCode
FOREIGN KEY(CountryCode)
REFERENCES Country(Code);

-- Airport.CountryCode -> Country.Code
ALTER TABLE Airport
ADD CONSTRAINT fk_Airport_CountryCode
FOREIGN KEY(CountryCode)
REFERENCES Country(Code);

-- MilitaryBase.CountryCode -> Country.Code
ALTER TABLE MilitaryBase
ADD CONSTRAINT fk_Military_Base_CountryCode
FOREIGN KEY(CountryCode)
REFERENCES Country(Code);

-- Port.CountryCode -> Country.Code
ALTER TABLE Port
ADD CONSTRAINT fk_Ports_CountryCode
FOREIGN KEY(CountryCode)
REFERENCES Country(Code);

-- insert 10 dummy tuples into the 3 new tables in the world database
-- all tuples have a CountryCode of 'USA'
-- insert into airport
INSERT INTO Airport(ID, CountryCode, Name, Runways)
VALUES
(1, 'USA', 'John F. Kennedy International', 1),
(2, 'USA', 'Los Angeles International', 2),
(3, 'USA', 'Hartsfield-Jackson International', 3),
(4, 'USA', 'Dallas International', 4),
(5, 'USA', 'Denver International', 5),
(6, 'USA', 'Portland International', 6),
(7, 'USA', 'Austin International', 7),
(8, 'USA', 'New York International', 8),
(9, 'USA', 'Chicago International', 9),
(10, 'USA', 'San Jose International', 10);

-- insert into MilitaryBase
INSERT INTO MilitaryBase(ID, CountryCode, Name, SurfaceArea)
VALUES
(1, 'USA', 'Fort Dallas', 1.0),
(2, 'USA', 'Fort Houston', 2.0),
(3, 'USA', 'Fort Chicago', 3.0),
(4, 'USA', 'Fort Tampa', 4.0),
(5, 'USA', 'Fort Portland', 5.0),
(6, 'USA', 'Fort Denver', 6.0),
(7, 'USA', 'Fort Austin', 7.0),
(8, 'USA', 'Fort Santa Barbara', 8.0),
(9, 'USA', 'Fort San Jose', 9.0),
(10, 'USA', 'Fort Sacremento', 10.0);

-- insert into Port
INSERT INTO Port(ID, CountryCode, Name, Docks)
VALUES
(1, 'USA', 'Port of Long Beach', 1),
(2, 'USA', 'Port of Los Angeles', 2),
(3, 'USA', 'Port of New York', 3),
(4, 'USA', 'Port of New Jersey', 4),
(5, 'USA', 'Port of Virginia', 5),
(6, 'USA', 'Port of South Carolina', 6),
(7, 'USA', 'Port of Houston', 7),
(8, 'USA', 'Port of Georgia', 8),
(9, 'USA', 'Port of Seattle-Tacoma', 9),
(10, 'USA', 'Port of Oakland', 10);
